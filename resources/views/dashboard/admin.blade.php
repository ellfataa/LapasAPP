            ...
            <div class="p-4 sm:p-6 lg:p-8 space-y-8 flex-1 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex items-center gap-5 transition hover:shadow-md hover:border-slate-300">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Total PK/Pengawas</p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex items-center gap-5 transition hover:shadow-md hover:border-slate-300">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Total Absensi Klien</p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex items-center gap-5 transition hover:shadow-md hover:border-slate-300">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Total Kinerja PK</p>
                            <p class="text-3xl font-extrabold text-slate-900">{{ $totalKinerja }}</p>
                        </div>
                    </div>
                </div>
